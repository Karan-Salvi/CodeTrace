...
# One-time TLS bootstrap: obtains the first Lets Encrypt certificate via
# certbots standalone plugin, which needs port 80 free -- run this BEFORE
# ever starting the nginx service, since nginxs config requires the cert
